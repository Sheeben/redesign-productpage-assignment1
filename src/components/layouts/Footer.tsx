        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="font-bold text-2xl mb-4 flex items-center">
              <span className="text-pink-400">Go</span>
              <span className="text-purple-400">GetWell</span>
              <span className="text-pink-400 text-xl">-ai</span>
            </div>
            <p className="text-gray-400 mb-4">
              Empowering your health journey with AI-driven insights and personalized wellness plans.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-purple-400  transition-colors">HIPAA Compliance</a></li>
