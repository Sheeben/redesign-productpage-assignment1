  ...
  return (
    <section className="py-20 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              The Future of Healthcare Is <span className="text-purple-600">Personal</span>
            </h2>
            ...
            <ul className="mb-8 space-y-3">
              {benefits.map((benefit, index) => (
                <li key={index} className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-purple-500 mr-2 flex-shrink-0 mt-0.5" />
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative">
              <div className="absolute -top-20 -left-10 w-96 h-96 bg-purple-300 rounded-full"></div>
              <img 
                src="https://img.freepik.com/premium-photo/female-doctor-examining-patient-clinic_1048944-20733411.jpg" 
      ...
      <Container className="mt-24">
        <div className="bg-gradient-to-r from-purple-600 to-purple-500 rounded-2xl p-8 md:p-12 text-white">
          <div className="max-w-3xl mx-auto text-center">
            <svg className="w-12 h-12 mx-auto mb-4 text-purple-100 opacity-80" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
