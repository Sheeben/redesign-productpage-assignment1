        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative">
              <div className="absolute -top-20 -left-10 w-96 h-96 bg-blue-300 rounded-full"></div>
              <img 
                src="https://img.freepik.com/free-photo/young-doctor-supporting-his-patient_1098-2237.jpg" 
